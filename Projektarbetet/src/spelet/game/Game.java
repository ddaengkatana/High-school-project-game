...
public class Game extends Canvas implements Runnable {
	...
	public void init(){
		...
		player = new Player(level, 0, 0, input, JOptionPane.showInputDialog(this, "Användarnamn?"));
	...
	public void run() {
		...
		while (running){
			if (level.done()) {
				JOptionPane.showMessageDialog(this, "Du vann! Din poäng blev " + Math.round(player.score));
				System.exit(0);
				}
				if (player.isDead()) {
